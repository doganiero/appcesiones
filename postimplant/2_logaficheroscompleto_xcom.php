...
set_time_limit(0);
$sql_buff="SELECT  CODCARGA, CODBUFFER, FICHERO_ORIGEN, DESEMPRESA_DESTINO, IP_DESTINO, NOMBREMAQUINA_DESTINO FROM TBUFFER WHERE CODCARGA='000001'"; //<---- falta group by fichero origen y desempresa
...
$sql_envb = "SELECT b.CODBUFFER, b.CODCARGA, b.CODENVIO, b.FICHERO_ORIGEN, c.CODCANAL, b.NOMBREMAQUINA_ORIGEN, b.IP_ORIGEN, b.IP_DESTINO, b.MOTIVOLOG, b.DESEMPRESA_DESTINO, b.NOMBREMAQUINA_DESTINO, b.IP_DESTINO FROM tbuffer b, tcargas c  WHERE b.CODCARGA='$CODCARGA' AND b.CODBUFFER='$CODBUFFER' AND b.CODCARGA=c.CODCARGA  ";
...
if ($ip_destino==0)
    $ip_destino = $nombre_maquinad;
        ...
        $sql_codenviobuf="UPDATE tbuffer SET CODENVIO='$sig_env', MOTIVOLOG='FICHERO AUTORIZADO - ANÁLISIS DE CONSOLIDACIÓN' WHERE CODCARGA='$codcarga' AND trim(FICHERO_ORIGEN)=trim('$BUFFER_FICHERO_ORIGEN') AND (NOMBREMAQUINA_DESTINO='$nombre_maquinad' OR IP_DESTINO='$ip_destino' )  "; 
