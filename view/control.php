...
<script type="text/javascript">
    ...
    function GridBuffer(var1, var2, var3, carga, var4, agrupa) { // esta función crea el grid y filtra la tabla según parámetros
        ...
        jQuery("#bufferlist").jqGrid({
            url: 'json/buffer_json.php?codcarga=' + carga + '&agrupa=' + agrupa,
            width: 1140,
            height: 530,
            datatype: "json",
            colNames: [
            ...
            multiboxonly: true,
            multiselectWidth: 40,
            caption: "" + tit.toUpperCase() + "" + '<span  class="ui-paging-info" style="margin-left:720px; color:white; font-size: 15px; white-space: nowrap;"><strong style="color: black; " >S: </strong><span id="contregs" style="color: black; "></span><strong style="color: DarkBlue; ">  &nbsp;&nbsp;E: </strong><span id="contrege" style="color: DarkBlue; "></span><strong style="color: #A60808; ">  &nbsp;&nbsp;N: </strong><span id="contregn" style="color: #A60808; "></span><strong style="color: DarkGreen; ">  &nbsp;&nbsp;D: </strong><span id="contregd" style="color: DarkGreen; " ></span></span>',
            shrinkToFit: false,
    ...
    $(document).ready(function() {
        ...
        $('#botonDetalleHistorico').button().click(function(evento) {
            ...
            $.ajax({
                type: "POST",
                url: 'json/bufferhist_json.php?nomfich=' + campos.BUFFER_FICHERO_ORIGEN,
                dataType: 'json',
                success: function(data) {
                    var index;
        ...
        $("#control").css({background: "#77c5e1"}); //seleccionar opción actual del menú principal
