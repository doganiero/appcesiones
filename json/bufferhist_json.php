...
$conslogs = mysql_query(" SELECT C.FICHERO_LOG, B.CHKCONTROL, B.BUFFER_DESCANAL, B.DESEMPRESA_DESTINO, B.BUFFER_NOMBREMAQUINA_DESTINO, B.BUFFER_IP_DESTINO  FROM V_CARGAS C, V_BUFFER B WHERE C.CODCARGA=B.CODCARGA AND B.BUFFER_FICHERO_ORIGEN='$nomfich'  ORDER BY C.CODCARGA DESC ");
